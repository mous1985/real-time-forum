    ...
    async getHtml() {
        ...
        return `
            <div class="post-page">
                ...
                <p id="comments-title">Commentaires:</p>
                <div id="post-comments"></div>
                <div class="navigation-buttons">
                    <button id="prev-button">Précedent</button>
            ...
            (authorized ?
                ...
                <form id="comment-form" onsubmit="return false;">
                    <textarea id="comment-input" cols="30" rows="5" minlength="2" maxlength="128" placeholder="Laisser un commentaire" required></textarea>
                ...
                :
                `
                <p>Merci de vous connecter pour laisser un message</p>
                `
            )
            +
            `
