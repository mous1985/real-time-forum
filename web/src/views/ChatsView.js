            ...
            <div id="chats-container">
                ...
                <div>
                    <div id="chat-messages">
                        <p id="chat-messages-placeholder">Séléctionner un chat</p>
                    </div>
                    <form id="message-form">
                        <input type="text" id="message-input" size="64" placeholder="Envoyer un message" autocomplete="off" autofocus/>
                    </form>
                </div>
            </div>
        `;
